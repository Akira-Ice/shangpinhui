            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  :value="count"
                />
                <button href="javascript:" class="plus" @click="count++">
                  +
                </button>
                <button
                  href="javascript:"
...
export default {
  ...
  methods: {
    ...
    setSessionStorage() {
      let str = "";
      for (let spuSaleAttr of this.spuSaleAttrList) {
        str += spuSaleAttr.saleAttrName + ":";
        for (let spuSaleAttrValue of spuSaleAttr.spuSaleAttrValueList) {
          if (spuSaleAttrValue.isChecked == "1") {
            str += spuSaleAttrValue.saleAttrValueName;
            break;
          }
        }
        str += " ";
      ...
      sessionStorage.setItem("skuInfo", JSON.stringify(skuObj));
    },
    async addShopCar() {
      try {
    ...
    changeActive(spuSaleAttrValueList, spuSaleAttrValue) {
      let spuSaleAttr;
      for (spuSaleAttr of spuSaleAttrValueList) {
